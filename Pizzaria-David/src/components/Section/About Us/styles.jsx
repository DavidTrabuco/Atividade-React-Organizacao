export const AboutUsStyles = {
  ...
  //Essa parte pra cima o claude fez pra mim !!!

  label: "text-xs font-semibold text-white tracking-widest uppercase border-b-2 border-orange-500 pb-1 w-fit drop-shadow-sm",

  title: "text-transparent bg-clip-text bg-gradient-to-r from-white to-orange-200 text-2xl lg:text-3xl font-bold leading-snug drop-shadow-lg",

  paragraph: "text-sm text-gray-400 leading-relaxed",

  button: "w-fit mt-2 px-5 py-2 bg-orange-500 text-white text-xs font-bold tracking-widest uppercase transition-all duration-300 hover:bg-orange-600 hover:scale-105 hover:-translate-y-1 hover:shadow-lg hover:shadow-orange-500/40 active:scale-95 cursor-pointer",

  image: "w-full h-64 lg:h-80 object-cover rounded-sm shadow-lg transition-all duration-500 hover:scale-105 hover:brightness-110 hover:shadow-xl hover:shadow-black/50",
};
